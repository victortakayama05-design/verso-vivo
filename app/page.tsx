...
const audioSamples: AudioSample[] = [
  {
    ...
    subtitle: 'Nosso proposito',
    durationLabel: '2:30',
    audioUrl: '/audio/quando sentimentos ganham voz.mp3',
  ...
  },
  {
    ...
    subtitle: 'Fernanda e Marcos',
    durationLabel: '3:03',
    audioUrl: '/audio/nossa historia.mp3',
    coverLabel: 'Amostra romântica',
  },
  {
    id: 'familia',
    title: 'Homenagem em Familia',
    subtitle: 'Para Claudio',
    durationLabel: '2:22',
    audioUrl: '/audio/homenagem em família.mp3',
